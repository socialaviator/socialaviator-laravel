<header class="cs-site_header cs-style1 text-uppercase cs-sticky_header">
                ...
                <ul class="cs-nav_list">
                  ...
                  <li class="menu-item-has-children">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="case-study.php">Case Study Details</a>
                      </li>
                      <li>
    ...
    <style>
      ...
      .cs-site_branding {
        ...
        margin-top: 10px; /* Adjust the positioning if needed */
      }
    }
@media screen and (max-width: 575px) {
    .cs-site_branding img {
        max-height: 100%; /* Increase the height to a suitable size */
    }
}

@media screen and (min-width: 375px) and (max-width: 812px) {
    .cs-site_branding img {
        max-height: 100%; /* Adjust the size for iPhone 11 */
    }
}
    ...
    <div class="cs-side_header">
      ...
      <div class="cs-side_header_in">
        ...
        <a class="cs-site_branding" href="index.php">
          <img src="assets/images/admin_footer.png" alt="Logo" />
        </a>
        ...
        <div class="cs-side_header_box">
          ...
          <ul class="cs-contact_info cs-style1 cs-mp0">
            ...
            <li>
              ...
              <span>info@socialaviator.in</span>
            </li>
            <li>
              <svg
                width="14"
              ...
              <span>
                  5 Abhumik Complex, Maninagar East Ahmedabad Gujarat 380 008
              </span>
            </li>
          </ul>
        </div>
