...
export default function ServiceDetailsPage() {
              ...
              <Div className="col-lg-6">
                  {services.service_details?.info_list?.slice(0, 6).map((item, index) => (
                      <Fragment key={`first-lg-${index}`}>
                          <a href={item.url} className='cs-text_btn cs-type2' target='_blank'>{item.title}{<Icon icon="bi:arrow-right" />}</a>
                          <Spacing lg='20' md='10'/>
                      </Fragment>
                  ))}
              </Div>
 ...
 <a href={item.url} className='cs-text_btn cs-type2' target='_blank'>{item.title}{<Icon icon="bi:arrow-right" />}</a>                          <Spacing lg='20' md='10'/>
                      </Fragment>
                  ))}
              </Div>
            </Div>
