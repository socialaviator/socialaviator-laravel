          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <div class="cs-text_widget">
                  <img style="width:35%" src="assets/images/s-logo.png" alt="Thumb" />
                  <p style="margin-top: 0px;">
                   Ready to elevate your brand? Let's connect and turn your vision into reality.
                  </p>
                </div>
                <div class="cs-social_btns cs-style1">
                  <a href="https://www.linkedin.com/company/socialaviator/" class="cs-center">
                    <svg
                      width="15"
                      height="15"
                      viewBox="0 0 15 15"
                  ...
                  <a href="https://x.com/SocialAviator" class="cs-center">
                    <svg
                      width="13"
                      height="11"
                      viewBox="0 0 13 11"
                  ...
                  <a href="https://www.facebook.com/socialaviator" class="cs-center">
                    <i class="fa-brands fa-facebook-f"></i>
                  </a>
                  <a href="https://www.instagram.com/socialaviator/" class="cs-center">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                ...
                <ul class="cs-menu_widget cs-mp0">
                  <li>
                    <a href="service-details.php">PR Branding</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="service-details.php">Branding Services</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                ...
                <ul class="cs-menu_widget cs-mp0">
                  <li>5 Abhumik Complex, Maninagar East Ahmedabad Gujarat 380 008</li>
                  <li>+91 8200284896</li>
                  <li>info@socialaviator.in</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="cs-newsletter cs-style1">
                  <form action="#" class="cs-newsletter_form">
                    <input
                      ...
                      placeholder="info@socialaviator.in"
                    />
                  ...
                  <div class="cs-newsletter_text">
                    Empowering your brand's digital journey with innovative strategies and measurable success.
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="cs-bottom_footer">
          <div class="cs-bottom_footer_left">
            <div class="cs-copyright">Copyright © <?php echo date("Y"); ?> Social Aviators.</div>
          </div>
